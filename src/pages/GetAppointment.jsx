    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 font-['Nova_Round',cursive]">Schedule an Appointment</h1>
          <p className="text-gray-600 mb-8">Let's discuss your construction project and get started</p>
        </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <button 
                        ...
                        className="text-gray-600 hover:text-yellow-600 transition-colors cursor-pointer text-left"
                      >
                        ...
                        <div className="text-sm text-gray-500">(Mr. Munawar Khan)</div>
                      </button>
                    </div>
                  </div>
